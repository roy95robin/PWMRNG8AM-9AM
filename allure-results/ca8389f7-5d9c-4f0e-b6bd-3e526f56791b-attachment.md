...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://playwright.devngidsng/
Call log:
  - navigating to "https://playwright.devngidsng/", waiting until "load"
...
- generic [ref=e3]:
  - generic [ref=e6]:
    ...
    - paragraph [ref=e8]: Check if there is a typo in playwright.devngidsng.
    - generic [ref=e9]:
      - paragraph
      - list [ref=e10]:
        - listitem [ref=e11]:
